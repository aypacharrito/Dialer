...
export default function LandingClient(){
  ...
  return <main className={styles.site}>
    <nav className={styles.nav}><Link href="/landing" className={styles.brand}><span>P</span><b>Pacifica</b></Link><div><a href="#product">Product</a><a href="#pricing">Pricing</a><a href="#compare">Compare</a><Link href="/">Sign in</Link><a className={styles.navCta} href="#pricing">Start now</a></div></nav>
    ...
    <footer className={styles.footer}><div className={styles.brand}><span>P</span><b>Pacifica</b></div><p>Insurance sales CRM, browser dialer, and AI command center.</p><div><Link href="/terms">Terms</Link><Link href="/">CRM login</Link></div></footer>
  </main>;
}
