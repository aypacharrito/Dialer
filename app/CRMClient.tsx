...
export default function Page({clerkEnabled=false,isOwner=false}:{clerkEnabled?:boolean;isOwner?:boolean}){
  ...
  const nav:[View,string,string][]=[["dialer","Dialer","dial"],["leads","CRM contacts","users"],["ai","Pacifica AI","spark"],["quotes","Quote center","shield"],["campaigns","Pipeline","list"],["activity","Reports","chart"],["billing","Plans & billing","list"]];
