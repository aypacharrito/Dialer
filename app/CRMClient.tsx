...
type View = "office" | "opportunities" | "today" | "dialer" | "leads" | "miner" | "messages" | "ai" | "quotes" | "campaigns" | "clients" | "activity" | "settings";
...
export default function Page({clerkEnabled=false,isOwner=false,isPlatformOwner=false,workspaceId="local",currentUserName="Pacifica user",currentUserEmail="",userRole="owner"}:{clerkEnabled?:boolean;isOwner?:boolean;isPlatformOwner?:boolean;workspaceId?:string;currentUserName?:string;currentUserEmail?:string;userRole?:string}){
  ...
  const nav:[View,string,string][]=([["today","Today","spark"],["dialer","Dialer","dial"],["leads","Contacts","users"],["messages","Messages","chat"],["campaigns","Pipeline","list"],...(workspaceProfile.mode==="insurance"?[["opportunities","Opportunities","bulb"],["miner","Miner","pickaxe"]]:[]),...(workspaceProfile.industry==="legal"?[["office","Office calendar","calendar"]]:[]),["clients","Clients","shield"],["activity","Reports","chart"],["ai","Pacifica AI","robot"],["quotes","Industry Tools","shield"]] as [View,string,string][]);
  ...
  return <main className="app-shell" onDragEnter={onFileDragEnter} onDragOver={onFileDragOver} onDragLeave={onFileDragLeave} onDrop={onFileDrop}>
    ...
    <section className="workspace">
      ...
      {view==="office"&&workspaceProfile.industry==="legal"&&<div className="page-view"><OfficeDesk leads={leads} profile={workspaceProfile} onProfile={setWorkspaceProfile} isOwner={isOwner} onOpen={setSelectedLead}/></div>}
