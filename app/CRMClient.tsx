...
type View = "dialer" | "leads" | "messages" | "ai" | "quotes" | "campaigns" | "activity" | "billing" | "settings";
...
export default function Page({clerkEnabled=false,isOwner=false,workspaceId="local"}:{clerkEnabled?:boolean;isOwner?:boolean;workspaceId?:string}){
  ...
  const nav:[View,string,string][]=[["dialer","Dialer","dial"],["leads","CRM contacts","users"],["messages","Messages","chat"],["ai","Pacifica AI","spark"],["quotes","Industry tools","shield"],["campaigns","Pipeline","list"],["activity","Reports","chart"],["billing","Plans & billing","list"]];
